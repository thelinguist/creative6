...
function createGame() {
    var value =
        "<input type=\"text\" name=\"gameCode\" placeholder=\"What would you like to call your game?\"/>\n" +
...
function joinNewGame() {
    var value =
        "<input type=\"text\" name=\"gameCode\" placeholder=\"What game would you like to join?\"/>\n" +
